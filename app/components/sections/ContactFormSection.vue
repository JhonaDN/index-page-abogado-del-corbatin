  ...
  <section id="contacto" class="section section--navy">
    <div class="container cta-form__inner">
      <div class="cta-form__intro">
        ...
        <p>
          Cuéntame brevemente tu situación y te contacto para definir los siguientes pasos. No se
          requiere compromiso para escribir.
        </p>
      ...
      <form class="contact-form" novalidate @submit.prevent="handleSubmit">
        ...
        <div class="confidentiality-note">
          ...
          <p>
            <strong>Tu información es confidencial.</strong> Todo lo que compartas aquí está
            protegido por el secreto profesional del abogado y se usa exclusivamente para evaluar tu
            caso.
          </p>
        </div>
...
const validators: Record<string, () => string> = {
  ...
  privacidad: () =>
    fields.privacidad ? '' : 'Debes aceptar el aviso de privacidad para continuar.'
}
