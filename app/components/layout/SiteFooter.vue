  ...
  <footer class="footer">
    <div class="container footer__grid">
      ...
      <div class="footer__legal">
        ...
        <p class="footer__legal-item">
          ...
          <NuxtLink to="/legal/privacidad">Política de privacidad y tratamiento de datos</NuxtLink>
        </p>
      </div>
    </div>
    ...
    <div class="container footer__bottom">
      ...
      <p class="footer__disclaimer">
        Esta página tiene fines informativos y no constituye asesoría legal. Ningún resultado de casos anteriores
        garantiza un resultado similar en casos futuros.
      </p>
    </div>
  </footer>
</template>
